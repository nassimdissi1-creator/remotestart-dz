export const PRICING = {
  ...
  job_standard: { name: 'Standard Job Post', amount: 399, customerType: 'employer' as const },
  job_featured: { name: 'Featured Job Post', amount: 499, customerType: 'employer' as const },
} as const
